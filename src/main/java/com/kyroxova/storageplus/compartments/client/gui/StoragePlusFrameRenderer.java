...
public class StoragePlusFrameRenderer {
    ...
    public static void drawRegion(int x, int y, Region region) {
        Gui.drawScaledCustomSizeModalRect(x, y, (float) region.x, (float) region.y, region.width, region.height,
                region.width, region.height, (float) StoragePlusAtlas.ATLAS_WIDTH, (float) StoragePlusAtlas.ATLAS_HEIGHT);
    }

    public static void drawClippedRegion(int x, int y, Region region, int width, int height) {
        Gui.drawScaledCustomSizeModalRect(x, y, (float) region.x, (float) region.y, width, height,
                width, height, (float) StoragePlusAtlas.ATLAS_WIDTH, (float) StoragePlusAtlas.ATLAS_HEIGHT);
    }
